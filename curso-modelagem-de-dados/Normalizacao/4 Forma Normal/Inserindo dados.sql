...
('TLF001','CLT001', '(11)9876-5432'),
('TLF002','CLT001', '(11)1234-5678'),
('TLF003','CLT002', '(21)8765-4321'),
('TLF004','CLT003', '(11)1987-65432'),
('TLF005','CLT003', '(11)1123-45678'),
('TLF006','CLT004', '(31)5555-8888'),
('TLF007','CLT004', '(31)9999-7777'),
('TLF008','CLT005', '(47)2222-3333'),
('TLF009','CLT006', '(61)3333-2222'),
('TLF010','CLT007', '(71)9999-1111'),
('TLF011','CLT007', '(71)8888-2222'),
('TLF012','CLT008', '(81)7777-4444'),
('TLF013','CLT009', '(85)4444-6666'),
('TLF014','CLT009', '(85)5555-7777'),
('TLF015','CLT010', '(61) 3333-2222'),
('TLF016','CLT011', '(71)9998-1251'),
('TLF017','CLT011', '(71)8878-2472'),
('TLF018','CLT012', '(21)8765-4321'),
('TLF019','CLT013', '(81)7777-1578'),
('TLF020','CLT014', '(31)6555-8788'),
('TLF021','CLT014', '(31)1999-2377'),
('TLF022','CLT015', '(47)2452-2933'),
('TLF023','CLT016', '(85)4412-6176'),
('TLF024','CLT016', '(85)7555-1777'),
('TLF025','CLT017', '(98)6675-3433'),
('TLF026','CLT017', '(98)7713-1478'),
('TLF027','CLT018', '(84)1111-5555'),
('TLF028','CLT019', '(98)6666-3333'),
('TLF029','CLT019', '(98)7777-5555'),
('TLF030','CLT020', '(84)1111-5555');
...
('PED019', 'CLT018', '2023-07-18', 19.99),
...
INSERT INTO SALARIOS (COD_SAL_CAR, DEPARTAMENTO, CARGO, SALARIO_BASE) VALUES
('SBC001', 'Vendas', 'Vendedor', 3500.00),
('SBC002', 'Vendas', 'Gerente de Vendas', 5000.00),
('SBC003', 'Marketing', 'Analista de Mkt', 4200.000),
('SBC004', 'RH', 'Analista de RH', 3800.00),
('SBC005', 'RH', 'Gerente de RH', 5500.00);


INSERT INTO CARGOS_COLABORADORES(COD_COLAB, COD_SAL_CAR) VALUES
('CLB001', 'SBC001'),
('CLB002', 'SBC002'),
('CLB003', 'SBC003'),
('CLB004', 'SBC004'),
...
INSERT INTO DEPENDENTES(COD_DEPEN, COD_COLAB, DEPENDENTE) VALUES
('DPD001', 'CLB001', 'Maria João'),
('DPD002', 'CLB002', 'Ana Maria'),
('DPD003', 'CLB003', 'Aline Siuza'),
('DPD004', 'CLB004', 'Carlos Antonio'),
('DPD005', 'CLB004', 'Alberto Lima'),
('DPD006', 'CLB006', 'Maria Joana');